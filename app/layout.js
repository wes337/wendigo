        ...
        <div className="relative flex flex-col min-h-screen items-center justify-center font-sans z-1">
          <div className="flex items-center justify-center gap-2.5 my-2.5 3xl:mt-auto 3xl:pt-2.5">
            <div className="h-[40px] sm:h-[52px] md:h-[80px] w-auto">
              <Image
                className="w-full h-full object-contain drop-shadow-lg drop-shadow-zinc-500/50"
                src={"/logo.png"}
                width={938}
                height={1071}
                alt=""
            ...
            <h1 className="-mb-2 text-xl sm:text-3xl md:text-5xl font-black text-zinc-900 text-shadow-[2px_2px_0_white] text-shadow-zinc-800/10 uppercase">
              Wendigo Corp
            </h1>
          </div>
          <div className={box}>
